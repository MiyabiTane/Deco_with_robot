...
class Talk(object):
    ...
    def introduction(self):
        ...
        time.sleep(2)
        self.ans.say("今日は、シナモンの代わりに^start(animations/Stand/Gestures/Explain_11)コチさんの発表をお手伝いするよ",self.configuration)

        time.sleep(2)
        self.ans.say("みんな、どうぞよろしくね。^start(animations/Stand/Gestures/Hey_3)^wait(animations/Stand/Gestures/Hey_3)",self.configuration)
    ...
    def episode_54_3(self):
        ...
        #episode 5-4-3
        time.sleep(1)
        self.ans.say("コチさん、博士の卒業、本当におめでとう。")
